...
- The tutorial uses two database (to really illustrate the power of GraphQL), but skip the part related to a relational database (and annything related to Aliens ;-), and focus only the parts related to MongoDB
